...
public class CountDownViews extends View {
    ...
    private int mPaintBackGroundColor = Color.parseColor("#55B2E5");//初始值 p
    ...
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    public CountDownViews(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    public CountDownViews(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
