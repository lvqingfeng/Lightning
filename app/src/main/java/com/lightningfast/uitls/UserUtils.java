...
public class UserUtils {
    ...
    private static final String SHARED_NAME = "sdk_Shared";
    private static final String SHARE_PASSWORD = "sdk_password";
    private static final String FILE_NAME = "sdk.txt";
